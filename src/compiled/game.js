...
var cube = document.getElementById('gc');
...
var scoreBar = document.getElementById('fg');
var scoreMarker = document.getElementById('ma');
var scoreText = document.querySelector('#sc span');

var position = { x: 0, y: 0 // Track mouse position
};var words = []; // Word list
var timestamp = 0; // Used for deltaTime
var score = new Score();
var online = true; // VPN status
...
// Timer loop
var timerTick = function timerTick(_timestamp, skip) {
...
var flashClass = function flashClass(className, element, duration) {
